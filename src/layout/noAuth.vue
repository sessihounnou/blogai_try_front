...
<template>
  ...
  <div class="container mx-auto flex max-w-6xl flex-wrap items-center justify-between">
    <a href="#" class="flex items-center">
      ...
      <span class="self-center whitespace-nowrap text-xl font-semibold">BlogAi</span>
    </a>
    <div class="mt-2 sm:mt-0 sm:flex sm:order-2">
      <!-- Login Button -->
      <router-link to="/login"
      >
      <button type="button" class="rounde mr-3 hidden border border-blue-700 py-1.5 px-6 text-center text-sm font-medium text-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 sm:inline-block rounded-lg">Login</button></router-link>
      <router-link to="/register"><button type="button" class="rounde mr-3 hidden bg-blue-700 py-1.5 px-6 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 sm:mr-0 sm:inline-block rounded-lg">Register</button></router-link>
      <!-- Register Button -->
    ...
    <div class="hidden w-full items-center justify-between sm:order-1 sm:flex sm:w-auto" id="navbar-sticky">
      <ul class="mt-4 flex flex-col rounded-lg border border-gray-100 bg-gray-50 p-4 sm:mt-0 sm:flex-row sm:space-x-8 sm:border-0 sm:bg-white sm:text-sm sm:font-medium">
        ...
        <li>
          <router-link to="/about_us"><a href="#" class="block rounded py-2 pl-3 pr-4 text-gray-700 hover:bg-gray-100 sm:p-0 sm:hover:bg-transparent sm:hover:text-blue-700">About</a></router-link>
        </li>
        <li>
  ...
  <footer class="bg-white dark:bg-gray-900">
    <div class="container mx-auto px-6 py-20">
        ...
        <div class="sm:col-span-2">
            ...
            <div class="mx-auto mt-8 flex flex-col space-y-3 sm:flex-row sm:space-y-0">
            ...
            <button class="w-full transform rounded-lg bg-gray-800 px-6 py-2.5 text-sm font-medium tracking-wider text-white transition-colors duration-300 hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-80 sm:mx-4 sm:w-auto">Subscribe</button>
            </div>
        </div>
        ...
        <hr class="my-6 border-gray-200 dark:border-gray-700 sm:my-8" />
        ...
        <div class="flex items-center justify-between">
          ...
          <span class="self-center whitespace-nowrap text-white text-xl font-semibold">BlogAi</span>
        </a>
